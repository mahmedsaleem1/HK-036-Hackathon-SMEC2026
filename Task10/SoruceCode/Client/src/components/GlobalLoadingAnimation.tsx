...
export default function GlobalLoadingAnimation() {
    ...
    return (
        <div
            ...
            style={{
                animation: isLoading ? 'fadeIn 0.2s ease-in' : 'fadeOut 0.3s ease-out',
...
function BaseballSwing() {
    return (
        <div className="relative w-32 h-32">
            <div className="absolute" style={{ animation: 'ballFly 0.8s ease-out infinite', top: '50%', left: '0' }}>
            ...
            <div className="absolute" style={{ animation: 'batSwing 0.8s ease-in-out infinite', transformOrigin: 'bottom right', top: '25%', right: '25%' }}>
...
function TennisServe() {
    return (
        <div className="relative w-32 h-32">
            ...
            <div className="absolute bottom-1 right-2" style={{ animation: 'racketSwing 0.8s ease-in-out infinite', transformOrigin: 'bottom center' }}>
